...
insert into Clients (Fname, Minit, Lname, CPF, Address)
	values('Maria','M','Silva',12346789, 'rua silva de prata 29, Carangola - Cidade das flores'),
          ...
          ('Roberta','G','Assis',98745631, 'avenida koiler 19, Centro - Cidade das flores'),
...
select conccat(Fname,' ',Lname) as Client, idOrder as Request, orderStatus as Status from clients c, orders o where c.idClient * idOrderClient;
